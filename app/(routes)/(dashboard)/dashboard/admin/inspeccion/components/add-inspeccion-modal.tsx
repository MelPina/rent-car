...
export function AddInspeccionModal({ isOpen, onClose, onSuccess }: AddInspeccionModalProps) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      // Llamada a la API para crear la inspección
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Agregar Nueva Inspección</DialogTitle>
          <DialogDescription>Ingrese los datos para crear una nueva inspección de vehículo.</DialogDescription>
        </DialogHeader>
